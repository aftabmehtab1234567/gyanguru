...
<body>
    ...
    <div class="container-fluid">
        <div class="row" style="margin-top: 90px;">
            ...
            <?php
$shownQuizzes = array(); // Array to store the IDs of shown quizzes
...
if (mysqli_num_rows($res) > 0) {
    while ($data = mysqli_fetch_array($res)) {
        ...
        // Display quiz after listing all the questions for the current title
        ...
        if (mysqli_num_rows($quizRes) > 0) {
            ...
            $shownQuizzes[] = $quizData['quizid']; // Add the quiz ID to the shown quizzes array
            ?>
